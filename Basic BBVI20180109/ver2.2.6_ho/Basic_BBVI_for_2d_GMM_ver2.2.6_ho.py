...
KS = K * S
#_alpha = 0.0
_beta = tf.constant(10.0, shape=[K, D, D])
_gamma = 1.0
#num_epochs = 30
#num_samples = 50
num_epochs = 1000
...
init_rho = tf.constant(0.00000001)
...
with tf.name_scope("VariationalParameters"):
    ...
    lambda_muLambda = tf.Variable(10.0*unit_matrices, dtype=tf.float32, trainable=True, name='lambda_muLambda')
...
with tf.name_scope("GenerativeModel"):
    ...
    _sample_p_Lambda = p_Lambda.sample(sample_shape=[S])
