...
# Observation
#dataset_observation = pd.read_csv("C:/work/Basic_BBVI_for_2-dim_GMM/csv/ver_lambda_pi_and_lambda_z/1000stepOK35/gmm_data.csv")
#dataset_observation = pd.read_csv("C:/work/Basic_BBVI_for_2-dim_GMM/csv/ver_lambda_pi/1000stepOK19/gmm_data.csv")
...
hyper_V = [[[2.0, 0.8], [-0.3, 4.0]], [[5.0, 0.0], [0.0, 5.0]]]
