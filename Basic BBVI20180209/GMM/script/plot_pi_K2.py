...
#dataset_pi = pd.read_csv("C:/work/Basic_BBVI_for_2-dim_GMM/csv/ver_lambda_pi/1000stepOK19/res_pi_K2.csv")
#dataset_pi = pd.read_csv("C:/work/Basic_BBVI_for_2-dim_GMM/csv/ver_lambda_z/200stepOK3/res_pi_K2.csv")
dataset_pi = pd.read_csv("C:/work/Basic_BBVI_for_2-dim_GMM/csv/ver_lambda_pi_and_lambda_z/1000stepOK45/res_pi_K2.csv")
...
# to csv
data_frame = pd.DataFrame(index=[], columns=["pi_cl1", "pi_cl2"])
for epoch in range(num_epochs):
    series = pd.Series([pi_cl1[epoch], pi_cl2[epoch]], index=data_frame.columns)
    data_frame = data_frame.append(series, ignore_index=True)
data_frame.to_csv("res_plot_pi_K2.csv", index=False)
