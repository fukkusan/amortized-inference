...
def Input():
    ...
    sample_x2 = nprand.normal(alpha+20.0, beta, int(float(N)*0.2))	# Mixture ratio pi_2=0.2
    sample_x3 = nprand.normal(alpha-20.0, beta, int(float(N)*0.1))	# Mixture ratio pi_3=0.1
